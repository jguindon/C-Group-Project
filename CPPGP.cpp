...
// Question 1 Accounting Section
        ...
        functionPrograms();
         ...
         if(j==1){
          ...
          cout << "1. Yes Iam happy with my programs performances" << endl;
          cout << "2. No i am not happy with my programs performances" <<endl;
          cin >> l;
          if (l==1){
...
if (selection == 3){  //Questions for Marketing Department
